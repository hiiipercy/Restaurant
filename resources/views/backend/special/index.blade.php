        ...
        <div class="box box-solid">
            <div class="box-header with-border">
                <div class="box-tools pull-right">
                    {{-- <a href="{{ route('app.special.import') }}" class="btn btn-sm btn-info rounded-0"><i class="fa fa-upload fa-sm"></i> Import</a> --}}
                    <button type="button" class="btn btn-sm btn-primary rounded-0" onclick="showFormModal('New Special', 'Save')"><i class="fa fa-plus fa-sm"></i> Add Special</button>
                </div>
            </div>
            <div class="box-body">
...
@include('backend.special.update_or_store')
@endsection
@push('scripts')
    <script>
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "{{ route('app.special.update-or-store') }}";
            ...
            if (id) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#store_or_update_form #filter_name').val(data.data.filter_name);
        ...
        $(document).on('click','.change_status', function(){
            ...
            var url = "{{ route('app.special.status-change') }}"
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let url = "{{ route('app.special.delete') }}";
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "{{ route('app.special.bulk-delete') }}";
