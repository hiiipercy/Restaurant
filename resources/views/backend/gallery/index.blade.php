        ...
        <div class="box box-solid">
            <div class="box-header with-border">
                <div class="box-tools pull-right">
                    {{-- <a href="{{ route('app.gallery.import') }}" class="btn btn-sm btn-info rounded-0"><i class="fa fa-upload fa-sm"></i> Import</a> --}}
                    <button type="button" class="btn btn-sm btn-primary rounded-0" onclick="showFormModal('New Gallery', 'Save')"><i class="fa fa-plus fa-sm"></i> Add Gallery</button>
                </div>
            </div>
            <div class="box-body">
...
@include('backend.gallery.update_or_store')
@endsection
@push('scripts')
    <script>
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "{{ route('app.gallery.update-or-store') }}";
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let url = "{{ route('app.gallery.delete') }}";
            delete_data(id,url,row);
        });
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "{{ route('app.gallery.bulk-delete') }}";
