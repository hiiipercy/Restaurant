        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="store_or_update_form" method="POST">
                    ...
                    <x-form.inputbox name="list_1" labelName="List 1" required="required"/>
                    <x-form.inputbox name="list_2" labelName="List 2" required="required"/>
                    <x-form.inputbox name="list_3" labelName="List 3" required="required"/>
