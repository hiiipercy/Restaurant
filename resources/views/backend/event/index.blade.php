        ...
        <div class="box box-solid">
            <div class="box-header with-border">
                <div class="box-tools pull-right">
                    {{-- <a href="{{ route('app.event.import') }}" class="btn btn-sm btn-info rounded-0"><i class="fa fa-upload fa-sm"></i> Import</a> --}}
                    <button type="button" class="btn btn-sm btn-primary rounded-0" onclick="showFormModal('New Event', 'Save')"><i class="fa fa-plus fa-sm"></i> Add Event</button>
                </div>
            </div>
            <div class="box-body">
...
@include('backend.event.update_or_store')
@endsection
@push('scripts')
    <script>
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "{{ route('app.event.update-or-store') }}";
            ...
            if (id) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#store_or_update_form #list_1').val(data.data.list_1);
                        $('#store_or_update_form #list_2').val(data.data.list_2);
                        $('#store_or_update_form #list_3').val(data.data.list_3);
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let url = "{{ route('app.event.delete') }}";
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "{{ route('app.event.bulk-delete') }}";
