        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="store_or_update_form" method="POST">
                    ...
                    <x-form.inputbox name="tw_url" labelName="Twitter url" required="required"/>
                    <x-form.inputbox name="fb_url" labelName="Facebook url" required="required"/>
                    <x-form.inputbox name="ins_url" labelName="Instagram url" required="required"/>
                    <x-form.inputbox name="lin_url" labelName="LinkedIn url" required="required"/>
