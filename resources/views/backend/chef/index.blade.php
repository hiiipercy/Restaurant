        ...
        <div class="box box-solid">
            <div class="box-header with-border">
                <div class="box-tools pull-right">
                    {{-- <a href="{{ route('app.chef.import') }}" class="btn btn-sm btn-info rounded-0"><i class="fa fa-upload fa-sm"></i> Import</a> --}}
                    <button type="button" class="btn btn-sm btn-primary rounded-0" onclick="showFormModal('New Chef', 'Save')"><i class="fa fa-plus fa-sm"></i> Add Chef</button>
                </div>
            </div>
            <div class="box-body">
...
@include('backend.chef.update_or_store')
@endsection
@push('scripts')
    <script>
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "{{ route('app.chef.update-or-store') }}";
            ...
            if (id) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#store_or_update_form #tw_url').val(data.data.tw_url);
                        $('#store_or_update_form #fb_url').val(data.data.fb_url);
                        $('#store_or_update_form #ins_url').val(data.data.ins_url);
                        $('#store_or_update_form #lin_url').val(data.data.lin_url);
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "{{ route('app.chef.bulk-delete') }}";
