        ...
        <div class="box box-solid">
            <div class="box-header with-border">
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-sm btn-primary rounded-0" onclick="showFormModal('New Menu', 'Save')"><i class="fa fa-plus fa-sm"></i> Add Menu</button>
                </div>
            </div>
            <div class="box-body">
                <table class="table table-bordered table-hover table-striped" id="menu-datatable">
                    <thead>
                        <th>
...
@include('backend.menu.update_or_store')
@endsection
@push('scripts')
    <script>
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "{{ route('app.menu.update-or-store') }}";
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "{{ route('app.menu.bulk-delete') }}";
